          ...
          {items.map((item, index) => (
            ...
            >
              ...
              <div className="w-full lg:w-1/2 group relative">
                ...
                {/* Decorative Elements */}
                <div className={`absolute -bottom-6 -right-6 w-32 h-32 border-b-2 border-r-2 border-accent-500/30 hidden md:block ${
                   index % 2 === 1 ? "-left-6 -right-auto border-r-0 border-l-2" : ""
                }`}></div>
              </div>
