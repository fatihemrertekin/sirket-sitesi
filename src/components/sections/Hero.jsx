        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-6 lg:pr-12">
            ...
            <h1 className="text-5xl md:text-7xl font-bold leading-[1.1] mb-6 text-white" style={{ fontFamily: 'var(--font-playfair), serif' }}>
              Yaşam <br/>
              Alanlarınıza <br/>
              <span className="text-accent-500 italic font-light">Değer </span>
              Katalım
            </h1>
            
            <p className="text-lg md:text-xl text-primary-200 mb-10 max-w-lg font-light leading-relaxed">
              Estetik ve fonksiyonelliği bir araya getiren özgün mimari çözümlerle, hayallerinizdeki mekanları inşa ediyoruz.
            </p>
          ...
          <div className="lg:col-span-6 mt-12 lg:mt-0 relative">
            <div className="relative aspect-[4/5] md:aspect-square lg:aspect-[3/4] overflow-hidden group">
              {/* Image Placeholder */}
              <div className="absolute inset-0 bg-primary-800 flex items-center justify-center border border-primary-700">
                <span className="text-primary-400 font-light tracking-widest uppercase">Görsel (700x900)</span>
              </div>
              ...
              {/* Yüzen rozet */}
              <div className="absolute bottom-10 left-[-2rem] bg-primary-900 p-6 border-l-4 border-accent-500 hidden md:block shadow-2xl">
                <div className="text-4xl font-bold text-white" style={{ fontFamily: 'var(--font-playfair), serif' }}>15+</div>
